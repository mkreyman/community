defmodule Community.TaxReceipts.Email do
  import Bamboo.Email
  alias Community.Mailer
  alias Community.Contributions.Donor

  @from_address Application.get_env(:community, :from_address)
  @attachment_dir Application.get_env(:community, :tax_receipts_output_dir)
  @thank_you_letter Path.join(
                      @attachment_dir,
                      Application.get_env(:community, :thank_you_letter)
                    )
